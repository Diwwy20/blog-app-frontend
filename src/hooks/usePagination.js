...
export const usePagination = ({
  ...
  const paginationRange = useMemo(() => {
    // Our core logic is here.
    const totalPageNumbers = siblingCount + 5;

    // State 1 -> if the number of pages is less than page numbers
    ...
    // State 3 -> No right dots to show, but left dots to be show
    if(shouldShowLeftDots && !shouldShowRightDots){
    ...
    // State 4 -> Both left and right dots to be show
    if(shouldShowLeftDots && shouldShowRightDots){
